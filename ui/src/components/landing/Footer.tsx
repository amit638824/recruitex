              ...
              <div className="single-footer-caption mb-50">
                <div className="footer-tittle">
                  ...
                  <div className="footer-form">
                    <form className="subscribe_form relative mail_part" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="row d-flex justify-content-between align-items-center">
              <div className="col-xl-10 col-lg-10">
                <div className="footer-copy-right">
                  <p>
                    Copyright &copy;{new Date().getFullYear()} All rights reserved | This template is made with <FaHeart /> by <a href="https://colorlib.com" target="_blank" rel="noreferrer">Colorlib</a>
                  </p>
                </div>
              </div>
