...
import { FaUser, FaEnvelope, FaPhone, FaLock, FaEye, FaEyeSlash, FaMapMarkerAlt } from 'react-icons/fa'
...
const UpdateProfile = () => {
  ...
  const avatarSrc = preview || (data?.img ? `http://localhost:9000/uploads/${data.img}` : '')
